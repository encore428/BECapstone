...
beforeAll(async () => {
  console.log('******** BEGIN unit tests for actl **** ')
  await utils.setup()
...
afterAll(async () => {
  ...
  console.log('******** END   unit tests for actl **** ')
})
...
describe('ACTL Unit Tests', () => {
  describe('3: POST/actls/:tid, input validation, negative test cases', () => {
  ...
  describe('4: PUT/actls/:tid, input validation, negative test cases', () => {
    it('should reject 400 when :tid not numeric', async () => {
        const tid='xyz'
        const auid=1
        return await request(app)
  ...
  describe('5: DELETE/actls/:tid, input validation, negative test cases', () => {
    it('should reject 400 when :tid not numeric', async () => {
        const tid='xyz'
        const auid=1
        return await request(app)
  ...
  describe('6: POST/actls/:tid to create Actls', () => {
    for (idx=0;idx<utils.actls.length;idx++) {
      const i=idx
  ...
  describe('7: PUT,DELETE/actls/:tid to update and delete Actls', () => {
